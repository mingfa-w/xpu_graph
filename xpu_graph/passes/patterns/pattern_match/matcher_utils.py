...
class SubgraphMatcher:
    ...
    def _match_nodes(self, pn: Node, gn: Node, match: InternalMatch) -> bool:
        ...
        # WARNING(liuyuan): modifed from original code, Placeholder match is always prior to others.
        ...
        if (
            (len(pn.args) != len(gn.args) or list(pn.kwargs.keys()) != list(gn.kwargs.keys()))
