...
class AlignMMWeight(Pattern):
    ...
    def process(self, gm: fx.GraphModule):
        ...
        mm_nodes = [
            ...
            and node.target == torch.ops.xpu_ops.quant_matmul.default
        ]
        ...
        for node in mm_nodes:
            ...
            if weight_shape[0] % 512 == 0 and weight_shape[1] % 512 != 0:
                ...
                with maybe_disable_fake_tensor_mode():
                    ...
                    new_weight_name = get_constant_manager(gm).register_constant(
                        new_weight, node.args[1].target + "_transposed"
                    )
