...
def _is_serial_mm_2dot(
    ...
    if (node.target != "mlu_tmo_fused_matmul_replacement") and (
        node.target != "mlu_tmo_fused_matmul_add_replacement") and (
        node.target != "mlu_tmo_fused_matmul_act_replacement") and (
        node.target != "mlu_tmo_fused_matmul_add_act_replacement"
    ):
        return False, []
...
def _is_serial_mm_3dot(
    ...
    if (matmul_node.target != "mlu_tmo_fused_matmul_replacement") and (
        matmul_node.target != "mlu_tmo_fused_matmul_add_replacement") and (
        matmul_node.target != "mlu_tmo_fused_matmul_act_replacement") and (
        matmul_node.target != "mlu_tmo_fused_matmul_add_act_replacement"
    ):
        return False, []
