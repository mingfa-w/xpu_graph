...
def fn2(inputs, slice_, batch):
    ...
    where_9 = torch.where(inputs, zeros, slice_11)
    where_10 = torch.where(inputs, zeros, slice_12)
    cat = torch.cat([slice_1, where_0, where_1, where_2, slice_2, where_3, where_4, where_5, slice_3, where_6, where_7, where_8, where_9, slice_4, slice_5, where_10], dim=-1)
...
def fn3(inputs, slice_, batch):
    ...
    where_0 = torch.where(inputs, zeros, slice_2)
    where_1 = torch.where(inputs, zeros, slice_3)
    cat = torch.cat([where_0, where_1], dim=-1)
    stack = torch.stack([where_0, where_1], dim=0)
    return cat, stack
...
if __name__ == "__main__":
    ...
    where_slice_cat_test(xpu_graph_backend, fn3)
