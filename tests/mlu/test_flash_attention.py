...
class TestFA:
    def setup_class(self):
        self.xpu_graph_backend = xpu_graph.mlu_compiler(
            is_training=False, freeze=True, opt_level=OptLevel.level2, vendor_compiler_config=None
        )
...
if __name__ == "__main__":
    xpu_graph_backend = xpu_graph.mlu_compiler(
        is_training=False, freeze=False, debug=True, opt_level=OptLevel.level2, vendor_compiler_config=None
    )
